...
export default defineI18nConfig(() => ({
  ...
  fallbackLocale: 'nl',
  messages: {
    nl: { common: nlCommon, home: nlHome, capabilities: nlCapabilities, materials: nlMaterials, about: nlAbout, projects: nlProjects, contact: nlContact },
    en: { common: enCommon, home: enHome, capabilities: enCapabilities, materials: enMaterials, about: enAbout, projects: enProjects, contact: enContact },
  },
}))
